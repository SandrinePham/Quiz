...
const QuizDbz = () => {
  ...
  // Filtrer les questions en fonction de la catégorie et de la difficulté
  const questions = difficulty
    ? questionsData.questions.filter(
        (question) =>
          question.difficulty === difficulty && question.category === "Dragon Ball Z"
      ).slice(0, 5)
    : [];
